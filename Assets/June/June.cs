...
public class June {
	...
	public void javaCompileAndRun()
	{
		...
		Shell.shell("javac", "-classpath '" + JuneConfig.application_data_path + "/June/Java/bin/' "+JuneConfig.java_files_path+"/"+java_file_name);
		var o = Shell.shell("java", "-classpath '" + JuneConfig.application_data_path + "/June/Java/bin/:"+JuneConfig.java_files_path+"' "+class_name+" " + game_object_name);	
